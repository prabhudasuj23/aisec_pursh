...
class Finding(Base):
    ...
    # e.g. ["Req 6.3.3", "Req 11.3.1"]
    pci_dss_requirements: Mapped[list[str]] = mapped_column(JSON, nullable=False, default=list)
    # e.g. ["CC6.1", "CC7.2"]
    soc2_trust_criteria: Mapped[list[str]] = mapped_column(JSON, nullable=False, default=list)
